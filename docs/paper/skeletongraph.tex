...
\tbd{Final react-loop pass@1 table pending verification of the remaining arms.
Current verified state on the primary run: SG-Fusion 42/100, BM25 41/100,
Graphify 41/100, grep 39/100, Aider 36/95, \texttt{none} 29/81, SG-Rerank 32/99.
Two observations already stable: SG-Fusion is the top arm, and exceeds SG-Rerank
by ten points, indicating the dense leg earns its keep in this harness.}
...
from thousands of Python repositories with tasks postdating model cutoffs;
\tbd{report the decontaminated run if completed before submission}.
