...
1. Call `sg_overview` first at session start.
2. Use `sg_search` instead of grep/glob for function/symbol lookup.
3. Use `sg_get` / `sg_expand` instead of reading full files.
